...
<footer class="main_footer">
  <div class="top_footer footer">
    ...
    <!--Theme Switcher-->
    <div id="theme" class="footer__link">
      <a href="?style=pink" ><img class="footer__link__img" src="http://localhost:8888/wp-personal_website/wp-content/uploads/2016/08/ribbon.png" alt="Breast Cencer Awareness Style Theme"></a>
    </div>
    </div>
  </div>
